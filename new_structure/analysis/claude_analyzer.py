...
def analyze_data(processed_data, chart_image=None):
    try:
        ...
        if chart_image:
            content += f"\nChart image (base64 encoded): {processed_data['chart_image']}"
        content += "\n\nBased on the provided market data and chart image, analyze the situation and provide a trading recommendation."
